...
namespace xkfd
{
    class HindernisA : Hindernis
    {
        ...
        {
            // Positionen für Noten
            Vector2 notePos1 = new Vector2((int)position.X + 150, (int)position.Y + 550);
            Vector2 notePos2 = new Vector2((int)position.X + 40, (int)position.Y + 300);
